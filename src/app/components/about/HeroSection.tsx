...
export default function HeroSection() {
  return (
    <section
      id="history"
      className="bg-[#0103B8] pt-[100px] sm:pt-[150px] pb-[50px] flex flex-col md:flex-row justify-end w-full relative text-white overflow-hidden md:mx-0 px-4 sm:px-8"
    >
      {/* Лого */}
      <Image
      ...
      <div className="relative mx-auto text-left space-y-6 sm:space-y-8 z-10 max-w-full sm:max-w-[1241px]">
        <h1 className="text-[64px] sm:text-[100px] font-regular font-inter text-[rgba(255,255,255,0.37)] leading-none">
          Про нас
        </h1>
        <h2 className="text-[28px] sm:text-[56px] font-regular">Навіщо?</h2>
        <p className="text-[16px] sm:text-[20px] max-w-full sm:max-w-[806px] leading-relaxed font-inter">
          Наші роздуми виражені крізь наше ясне бачення. Європейська
          психологічна асоціація просуває європейські стандарти психологічної
          освіти, науки та практики в Україні, пропонуючи фахівцям інновації та
          взаємодію.
        </p>
        <h2 className="text-[28px] sm:text-[56px] font-regular">Створення</h2>
        <p className="text-[16px] sm:text-[20px] max-w-full sm:max-w-[1241px] leading-relaxed font-inter">
          ...
          асоціація - єдиний в Україні кластерний інкубатор освіти, створений у
          ...
          освіту, науку та практику як рушійну силу в особистісному,
