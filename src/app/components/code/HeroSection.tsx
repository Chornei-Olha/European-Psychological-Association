    ...
    <section className="bg-[#BFD6EC] px-[100px] pt-[100px] pb-[50px] flex justify-end w-full relative text-white overflow-hidden mx-4 md:mx-0">
      ...
      <div className="mx-auto px-6 text-left space-y-8 text-black">
        ...
        <p className="text-[23px] font-light font-inter">
          ...
          життєдіяльність. Об'єктом досліджень і впливу психологів є внутрішній
          світ особистості, тому їхні контакти з іншими людьми повинні бути
          теплими, доброзичливими, цілющими.
        </p>
        <p className="text-[23px] font-light font-inter">
          ...
          студентів; психологам у галузі охорони здоров'я - у виконанні функцій,
          пов'язаних з профілактикою захворювань, лікуванням, реабілітацією
          пацієнтів; психологам у сфері державного управління - у психологічному
          забезпеченні загального і галузевого управління.
        </p>
        <p className="text-[23px] font-light font-inter">
        ...
        <p className="text-[23px] font-light font-inter">
          ...
          виконання обов’язків) можуть бути показником професiйної непридатностi
        ...
        <p className="text-[23px] font-light font-inter">
          ...
          лікування можна дати об’єктивний професійний висновок, а у випадках,
          коли вiн не може дiяти в інтересах клiєнта, роз’яснює йому i батькам
          (опiкунам) реальний стан справ.
          <br />
        ...
        <p className="text-[23px] font-light font-inter">
          ІV. Конфіденційність.
          <br />
          4.1. Психолог зобов’язаний додержуватися конфiденцiйностi у всьому, що
          стосується взаємин з клієнтом, його особистого життя, життєвих
          обставин. Виняток становлять випадки, коли виявлені симптоми є
          небезпечними для клiєнта та iнших людей, i психолог зобов’язаний
          поiнформувати тих, хто може надати квалiфiковану допомогу.
          Конфіденційності можна не додержуватись, якщо клієнт просить або
          эгоджується, аби в його iнтересах iнформацiю було передано іншій
          особi.
          <br />
