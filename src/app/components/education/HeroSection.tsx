    ...
    <section className="bg-[#0103B8] pt-[150px] pb-[50px] flex justify-end w-full relative text-white overflow-hidden px-6">
      ...
      <div className="mx-auto text-left space-y-8 max-w-7xl z-10">
        ...
        <p className="pt-[20px] md:text-[20px] text-[16px] md:pt-[70px]">
          Методика викладання – це захоплюючий процес, який передбачає лекційні
          та практичні заняття, а також онлайн роботу, де слухач є активним
          учасником, а атестація знань та сертифікат відповідає Європейській
          системі трансферу оцінок (European Community Course Credit Transfer
          System). Освітні програми проходять незалежне експертне рецензування
          та затверджуються Експертною радою Є-П-А та вченими радами освітніх
          партнерів.
        </p>
      </div>
    </section>
