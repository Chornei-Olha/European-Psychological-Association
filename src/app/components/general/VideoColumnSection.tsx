...
export default function TwoColumnSection() {
  return (
    <section>
      <div className="container mx-auto py-12 grid grid-cols-1 md:grid-cols-2 gap-8 px-6 sm:px-4 sm: mb-[100px] md:mb-0">
        {/* Левая колонка */}
        <div className="flex flex-col justify-start">
          ...
          <p className="text-[16px] sm:text-[20px] font-regular font-inter text-black mt-[20px] sm:mt-[50px] w-full sm:w-[550px]">
            Освітній процес – це обмін досвідом за допомогою сучасних
            технологій. Кожен слухач має постійний он-лайн доступ до навчальних
            матеріалів (презентації, відео-контент, тощо), а викладачі є
            постійними менторами з Вами при опрацювання практичних кейсів.
          </p>
          <Link
            href="/education"
