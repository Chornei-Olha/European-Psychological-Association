  ...
  return (
    <section className="bg-[#D5E5FF] px-[100px] pt-0 pb-[50px] flex justify-end w-full relative text-white overflow-hidden mx-4 md:mx-0">
      ...
      <div className="container mx-auto py-16 px-4 text-black text-left max-w-[1241px]">
        ...
        <div className="bg-[rgba(57,115,225,0.18)] w-[1405px] h-[313px] mb-[45px] rounded-4xl"></div>
        <p className="text-[33px] font-inter font-regular text-left text-[rgba(0,0,0,0.18)]">
          Документ
        </p>
        <p className="text-[33px] font-inter font-regular text-left text-[rgba(0,0,0,0.18)]">
          Політика конфіденійності
        </p>
        <p className="text-[33px] font-inter font-regular text-left text-[rgba(0,0,0,0.18)] mb-[45px]">
          Заява шаблон
        </p>
      </div>
    </section>
